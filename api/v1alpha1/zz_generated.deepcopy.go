...
func (in *OSImageStatus) DeepCopyInto(out *OSImageStatus) {
	*out = *in
	out.WindowsBundle = in.WindowsBundle
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WindowsBundle) DeepCopyInto(out *WindowsBundle) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WindowsBundle.
func (in *WindowsBundle) DeepCopy() *WindowsBundle {
	if in == nil {
		return nil
	}
	out := new(WindowsBundle)
	in.DeepCopyInto(out)
	return out
}
